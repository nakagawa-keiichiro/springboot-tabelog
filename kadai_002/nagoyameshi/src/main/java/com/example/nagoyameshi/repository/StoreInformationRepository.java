...
public interface StoreInformationRepository extends JpaRepository<StoreInformation, Integer> {
    ...
    //public Page<StoreInformation> findByStoreNameLikeOrAddressLike(String nameKeyword, String addressKeyword, Pageable pageable);    
    //public Page<StoreInformation> findByAddressLike(String area, Pageable pageable);
    //public Page<StoreInformation> findByPriceLowerLimitLessThanEqual(Integer price, Pageable pageable); 
    //public Page<StoreInformation> findByCategoryId(Integer id, Pageable pageable);
